  ...
  return (
    ...
    <div className="card">
        <div className="card-body">
            ...
            <div className="row">
                <div className="col-md-1" style={{ marginRight: "10px", /*marginLeft: "10px"*/ }}>
                    <button type="button" className="btn btn-outline-success btn-sm" style={{ marginBottom: "5px", borderColor: "rgb(20, 141, 20)", fontSize: "10px" }}>A807AF</button><br />
                    <button type="button" className="btn btn-outline-success btn-sm" style={{ borderColor: "rgb(20, 141, 20)", fontSize: "10px" }}>A807AF</button>
                </div>
                <div className="col-md-1" style={{ marginRight: "10px", marginLeft: "10px" }}>
                    <button type="button" className="btn btn-outline-success btn-sm" style={{ marginBottom: "5px", borderColor: "rgb(20, 141, 20)", fontSize: "10px" }}>A807AF</button><br />
                    <button type="button" className="btn btn-outline-success btn-sm" style={{ borderColor: "rgb(20, 141, 20)", fontSize: "10px" }}>A807AF</button>
